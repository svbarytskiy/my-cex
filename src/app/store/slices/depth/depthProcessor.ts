...
class DepthProcessor {
  ...
  private getSortedDepthLevels(map: Record<string, string>, type: 'bid' | 'ask'): DepthLevel[] {
  ...
  public initializeSnapshot(snapshotBids: DepthLevel[], snapshotAsks: DepthLevel[], lastId: number): ProcessedDepthData {
    ...
    const relevantBufferedUpdates = this.updateBuffer.filter(
      event => event.u > this.currentLastUpdateId
